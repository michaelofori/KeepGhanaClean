...
class LocationService {
  final String key = 'AIzaSyCsDG0wJUNnciSuJpnVd95JcxxmtOtgBJA';
  ...
  Future<Map<String, dynamic>> getDirections(String origin, String destination) async {
      ...
      final String url = 'https://maps.googleapis.com/maps/api/directions/json?origin&destination=&key=$key';
