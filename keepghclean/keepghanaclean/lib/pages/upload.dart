...
import 'package:keepghanaclean/components/progress.dart';
...
class _UploadState extends State<Upload> {
  ...
  getUserLocation() async {
    ...
    Placemark pkacemark = placemarks[0];
    String completeAddress = '${placemark.subThroughfare} $
    {placemark.throughfare}, ${placemark.subLocality} $
    {placemark.locality}, ${placemark.subAdministrativeArea}, $
    {placemark.subAdministrativeAre}, ${placemark.postalCode}, $ 
    ${placemark.country}';
